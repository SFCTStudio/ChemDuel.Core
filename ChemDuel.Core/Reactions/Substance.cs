...
public readonly struct Substance
{
    ...
    private static void AddElementToAtoms(ref Dictionary<Element, int> atoms, ref Element cacheElem,
        ref Dictionary<Element, int> cacheDict, int num = 1)
    {
